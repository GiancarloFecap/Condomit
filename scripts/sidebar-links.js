...
Object.assign(textTranslations.en, {
    "Descreva o comunicado": "Describe the announcement",
    "O que você quer comunicar hoje?": "What would you like to communicate today?",
    "Descreva em poucas palavras o objetivo do comunicado. A IA irá gerar um texto profissional, claro e adequado para os moradores.": "Briefly describe the purpose of the announcement. AI will generate a professional, clear message suitable for residents.",
    "Gerar rascunho com IA": "Generate AI draft",
    "Resultado da IA": "AI result",
    "Rascunho do comunicado": "Announcement draft",
    "Confira o comunicado gerado. Você pode refinar, copiar o texto ou enviar diretamente para o mural de avisos.": "Review the generated announcement. You can refine it, copy the text or send it directly to the Notice Board.",
    "Título aparecerá aqui": "The title will appear here",
    "Refinar": "Refine",
    "Copiar texto": "Copy text",
    "Enviar comunicado": "Send announcement",
    "Histórico": "History",
    "Comunicados recentes": "Recent announcements",
    "Acesse os últimos comunicados gerados pela IA.": "Access the latest announcements generated by AI.",
    "Nenhum comunicado gerado ainda.": "No announcements generated yet.",
    "Dicas": "Tips",
    "Sugestões de uso": "Usage suggestions",
    "Saiba como aproveitar melhor a IA para seus comunicados.": "Learn how to make better use of AI for your announcements.",
    "Inclua datas e horários para maior clareza": "Include dates and times for greater clarity",
    "Especifique o bloco/apartamento se for algo pontual": "Specify the block/apartment when relevant",
    "Sempre revise antes de enviar para os moradores": "Always review the message before sending it to residents",
    "Categorize: Manutenção, Eventos, Avisos, Regras, etc.": "Categorize: Maintenance, Events, Notices, Rules, etc.",
    "AI Condomit": "Condomit AI",
    "Seu assistente inteligente para dúvidas sobre o condomínio.": "Your smart assistant for condominium questions.",
    "Assistente Condomit": "Condomit Assistant",
    "Conectando ao seu condomínio...": "Connecting to your condominium...",
    "Nova conversa": "New conversation",
    "Dúvidas do seu condomínio": "Questions about your condominium",
    "Como posso ajudar?": "How can I help?",
    "Reservas": "Reservations",
    "Locais, horários e minhas reservas": "Common areas, times and my reservations",
    "Visitantes": "Visitors",
    "Assembleias": "Assemblies",
    "Notificações": "Notifications",
    "Corrigir assinatura": "Correct signature",
    "Corrigir assinatura da ata": "Correct minutes signature",
    "Salvar nova assinatura": "Save new signature",
    "Assinar ata": "Sign minutes",
    "Desenhe a nova assinatura. Ao salvar, ela substituirá a assinatura anterior.": "Draw the new signature. When saved, it will replace the previous signature."
});
...
async function refreshSidebarCondominiumLogo(user) {
    ...
    if (sidebarCondoLogoCache.has(cep)) {
        ...
        logoElements.forEach((img) => { img.dataset.condoLogo = cached !== fallback ? 'true' : 'false'; img.src = cached; });
        return;
    }
